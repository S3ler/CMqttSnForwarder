...
EXPECT_EQ(MqttSnForwarderLoop(&mqttSnForwarder),
0);
}
...
GTEST_SKIP()
<< "not testable - AddForwardingHeaderToClientMessages always returns 0";
}
...
GTEST_SKIP()
<< "not testable - RemoveForwardingHeaderFromGatewayMessages always returns 0";
}
