  ...
  static MqttSnMessageData generateM1MqttSnPublishMqttSnMessageData(uint16_t data_length,
    ...
    if ((data_length + MQTT_SN_M1_PUBLISH_HEADER_LENGTH_WITHOUT_LENGTH + MQTT_SN_SHORT_LENGTH) > 255) {
      ...
      if (data_length > UINT16_MAX - MQTT_SN_M1_PUBLISH_HEADER_LENGTH_WITHOUT_LENGTH - MQTT_SN_LONG_LENGTH) {
        ...
        if (data_length > MAX_MESSAGE_LENGTH - MQTT_SN_M1_PUBLISH_HEADER_LENGTH_WITHOUT_LENGTH - MQTT_SN_LONG_LENGTH) {
          data_length = MAX_MESSAGE_LENGTH - MQTT_SN_M1_PUBLISH_HEADER_LENGTH_WITHOUT_LENGTH - MQTT_SN_LONG_LENGTH;
        }
      }
    ...
    if (data_length > UINT8_MAX - MQTT_SN_M1_PUBLISH_HEADER_LENGTH_WITHOUT_LENGTH - MQTT_SN_SHORT_LENGTH) {
      ...
      if (data_length > MAX_MESSAGE_LENGTH - MQTT_SN_M1_PUBLISH_HEADER_LENGTH_WITHOUT_LENGTH - MQTT_SN_SHORT_LENGTH) {
        data_length = MAX_MESSAGE_LENGTH - MQTT_SN_M1_PUBLISH_HEADER_LENGTH_WITHOUT_LENGTH - MQTT_SN_SHORT_LENGTH;
      }
    }
