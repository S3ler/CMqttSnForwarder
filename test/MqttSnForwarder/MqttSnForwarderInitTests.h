...
#ifndef CMQTTSNFORWARDER_MQTTSNFORWARDERINITTESTS_H
...
class MqttSnForwarderInitTests : public ::testing::Test {
 public:
  ...
  MqttSnForwarderInitTests() {}
  virtual ~MqttSnForwarderInitTests() {}
};

#endif //CMQTTSNFORWARDER_MQTTSNFORWARDERINITTESTS_H
