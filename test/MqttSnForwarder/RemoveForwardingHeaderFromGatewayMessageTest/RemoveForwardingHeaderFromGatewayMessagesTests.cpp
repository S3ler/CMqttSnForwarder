...
EXPECT_EQ(RemoveForwardingHeaderFromGatewayMessages(&mqttSnForwarder, &gatewayMessageData, &clientMessageData),
0);
}
...
ASSERT_EQ(RemoveForwardingHeaderFromGatewayMessages(&mqttSnForwarder, &gatewayMessageData, &clientMessageData),
0);
...
MqttSnMessageData mqttSnMessageDataZeroed = {0};
ASSERT_EQ(memcmp(&gatewayMessageData, &mqttSnMessageDataZeroed, sizeof(MqttSnMessageData)),
0);
}
