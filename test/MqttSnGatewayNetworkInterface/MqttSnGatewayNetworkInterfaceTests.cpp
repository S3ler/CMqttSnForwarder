...
EXPECT_EQ(mqttSnGatewayNetworkInterface
.gateway_network_address, &forwarder_gateway_network_address);
}
...
EXPECT_EQ(mqttSnGatewayNetworkInterface
.gateway_network_init, mock_gateway_network_init);
}
...
EXPECT_EQ(mqttSnGatewayNetworkInterface
.gateway_network_connect, mock_gateway_network_connect);
}
...
EXPECT_EQ(mqttSnGatewayNetworkInterface
.gateway_network_disconnect, mock_gateway_network_disconnect);
}
...
EXPECT_EQ(mqttSnGatewayNetworkInterface
.gateway_network_receive, mock_gateway_network_receive);
}
...
EXPECT_EQ(mqttSnGatewayNetworkInterface
.gateway_network_send, mock_gateway_network_send);
}
...
ASSERT_EQ(mqttSnGatewayNetworkInterface
.gateway_network_connect, mock_gateway_network_connect);
...
EXPECT_EQ(GatewayNetworkConnect(&mqttSnGatewayNetworkInterface, gatewayNetworkContext),
0);
}
...
ASSERT_EQ(GatewayNetworkConnect(&mqttSnGatewayNetworkInterface, gatewayNetworkContext),
0);
