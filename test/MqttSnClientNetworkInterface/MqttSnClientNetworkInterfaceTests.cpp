...
ASSERT_EQ(ClientNetworkInit(&mqttSnClientNetworkInterface,
                            ...
                            mock_client_network_init),
0);

EXPECT_EQ(mqttSnClientNetworkInterface
.status, 1);
}
...
EXPECT_EQ(mqttSnClientNetworkInterface
.client_network_address, &forwarder_client_network_address);
}
...
EXPECT_EQ(mqttSnClientNetworkInterface
.client_network_init, mock_client_network_init);
}
...
EXPECT_EQ(mqttSnClientNetworkInterface
.client_network_connect, mock_client_network_connect);
}
...
EXPECT_EQ(mqttSnClientNetworkInterface
.client_network_disconnect, mock_client_network_disconnect);
}
...
EXPECT_EQ(mqttSnClientNetworkInterface
.client_network_receive, mock_client_network_receive);
}
...
EXPECT_EQ(mqttSnClientNetworkInterface
.client_network_send, mock_client_network_send);
}
...
ASSERT_EQ(mqttSnClientNetworkInterface
.client_network_connect, mock_client_network_connect);
...
EXPECT_EQ(ClientNetworkConnect(&mqttSnClientNetworkInterface, clientNetworkContext),
0);
}
...
ASSERT_EQ(ClientNetworkConnect(&mqttSnClientNetworkInterface, clientNetworkContext),
0);
