...
class MqttSnTestMessageReceiverMock : public MqttSnTestMessageReceiverInterface {
public:
    ...
    MOCK_METHOD1(receive_willtopicupd,
               void(test_willtopicupd *pWilltopicupd));

    MOCK_METHOD1(receiver_willmsgupd,
               void(test_willmsgupd *pWillmsgupd));

    MOCK_METHOD1(receive_willtopicresp,
               void(test_willtopicresp *pWilltopicresp));

    MOCK_METHOD1(receiver_willmsgrsp,
               void(test_willmsgrps *pWillmsgrsp));

    MOCK_METHOD1(receiver_forwarder_encapsulation,
               void(test_forwarderencapsulation *pForwarderencapsulation));
