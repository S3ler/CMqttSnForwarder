...
#include <cstdint>
#include "MqttSnTestMessages.hpp"

class MqttSnTestMessageReceiverInterface {

 public:
  virtual ~MqttSnTestMessageReceiverInterface() {};
  ...
  virtual void receive_willtopicupd(test_willtopicupd *pWilltopicupd) = 0;

  virtual void receiver_willmsgupd(test_willmsgupd *pWillmsgupd) = 0;

  virtual void receive_willtopicresp(test_willtopicresp *pWilltopicresp) = 0;

  virtual void receiver_willmsgrsp(test_willmsgrps *pWillmsgrsp) = 0;

  // TODO receiver_pingreq

  // TODO receiver_pingresp

  virtual void receiver_forwarder_encapsulation(test_forwarderencapsulation *pForwarderencapsulation) = 0;
