...
class MqttSnClientSearchGwConnectAction : public MqttSnClientConnectAction {
 public:
  const int32_t search_gateway_wait_timeout;
  const uint8_t search_gateway_radius;
  MqttSnClientSearchGwConnectAction(const MqttSnClientProtocolTestType a_protocol,
                                    const int32_t search_gateway_wait_timeout,
                                    const uint8_t search_gateway_radius,
