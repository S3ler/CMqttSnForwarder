...
::std::vector<MqttSnGatewayNetworkTcpNetworkDefragmentationTestParameter> getMqttSnGatewayNetworkTcpNetworkDefragmentationTestParameter(
...
#endif //CMQTTSNFORWARDER_GETMQTTSNGATEWAYNETWORKTCPNETWORKDEFRAGMENTATIONTESTPARAMETER_H
