...
class MqttNetworkBuilderMqttBrokerBuilderConfiguration {
 public:
  ...
  MqttNetworkBuilderMqttBrokerBuilderConfiguration(const MqttBrokerTestType type, const uint16_t max_broker_count, const MqttBrokerProtocolTestType protocol_type, const std::string &broker_address,
