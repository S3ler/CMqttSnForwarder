...
int32_t ssd1306_screen_log_str(const MqttSnLogger *logger, const char *str){
  Serial.print(str);
...
int32_t ssd1306_screen_log_char(const MqttSnLogger *logger, char c){
  char str[2];
  str[0] = c;
  str[1] = '\0';
  return ssd1306_screen_log_str(logger, str);
}
