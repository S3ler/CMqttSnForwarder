...
int32_t process_mqtt_sn_gateway__config_line(mqtt_sn_gateway__config *cfg, const MqttSnLogger *logger, int argc, char *argv[]) {
  ...
  if (config_file_index) {
    ...
    if (process_config_file(config_file_path, logger, cfg, mqtt_sn_gateway__config_file_process_command_callback, argv[0])
