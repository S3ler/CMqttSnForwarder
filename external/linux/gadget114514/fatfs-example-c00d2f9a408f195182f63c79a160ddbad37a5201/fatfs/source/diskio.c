...
#define SECCOUNT 128
#endif
//#define WITH_LINUX_FTFS_DISCIO_DEBUG_LOGGING
#ifdef WITH_LINUX_FTFS_DISCIO_DEBUG_LOGGING
#define WITH_LINUX_FTFS_DISCIO_DEBUG_LOGGING_ON
#endif
...
#ifdef WITH_LINUX_FTFS_DISCIO_DEBUG_LOGGING_ON
