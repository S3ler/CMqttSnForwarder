...
#include <gateway_old/core/CoreInterface.h>
#include <gateway_old/paho/pahomqttembeddedc/MQTTClient/src/MQTTClient.hpp>
#include <gateway_old/paho/pahomqttembeddedc/MQTTClient/src/linux/linux.cpp>
