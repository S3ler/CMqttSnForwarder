...
#define MQTT_SN_MESSAGE_SUBSCRIBE_W_TOPICID_LENGTH               (MQTT_SN_MESSAGE_SUBSCRIBE_HEADER_LENGTH(0) + \
                                                                 MQTT_SN_MESSAGE_SUBSCRIBE_FLAGS_LENGTH + \
                                                                 MQTT_SN_MESSAGE_SUBSCRIBE_MSG_ID_LENGTH + \
...
#define MQTT_SN_MESSAGE_SUBSCRIBE_W_TOPICNAME_MIN_LENGTH         (MQTT_SN_MESSAGE_SUBSCRIBE_HEADER_LENGTH(0) + \
                                                                 MQTT_SN_MESSAGE_SUBSCRIBE_FLAGS_LENGTH + \
                                                                 MQTT_SN_MESSAGE_SUBSCRIBE_MSG_ID_LENGTH + \
...
#define MQTT_SN_MESSAGE_SUBSCRIBE_WO_TOPICNAME_MAX_LENGTH        (MQTT_SN_MESSAGE_SUBSCRIBE_HEADER_LENGTH(1) + \
                                                                 MQTT_SN_MESSAGE_SUBSCRIBE_FLAGS_LENGTH + \
                                                                 MQTT_SN_MESSAGE_SUBSCRIBE_MSG_ID_LENGTH)
...
#define MQTT_SN_MESSAGE_SUBSCRIBE_W_TOPICNAME_MAX_LENGTH         (MQTT_SN_MESSAGE_SUBSCRIBE_WO_TOPICNAME_MAX_LENGTH + MQTT_SN_MESSAGE_SUBSCRIBE_WO_TOPICNAME_MAX_LENGTH)
