...
#define MQTT_SN_MESSAGE_WILLTOPICREQ_HEADER_LENGTH   MQTT_SN_MESSAGE_HEADER_SHORT_LENGTH
#define MQTT_SN_MESSAGE_WILLTOPICREQ_LENGTH          MQTT_SN_MESSAGE_WILLTOPICREQ_HEADER_LENGTH
