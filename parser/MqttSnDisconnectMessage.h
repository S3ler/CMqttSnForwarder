...
#define MQTT_SN_MESSAGE_DISCONNECT_WO_DURATION_LENGTH MQTT_SN_MESSAGE_DISCONNECT_HEADER_LENGTH
#define MQTT_SN_MESSAGE_DISCONNECT_W_DURATION_LENGTH (MQTT_SN_MESSAGE_DISCONNECT_HEADER_LENGTH + MQTT_SN_MESSAGE_DISCONNECT_DURATION_LENGTH)
