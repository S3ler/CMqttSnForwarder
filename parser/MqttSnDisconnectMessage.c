...
static int32_t parse_disconnect_internal_duration(const uint8_t *src_pos,
                                                  uint16_t src_len,
                                                  int32_t *parsed_bytes,
                                                  uint16_t *duration);
...
int32_t parse_disconnect_internal_duration(const uint8_t *src_pos,
                                           uint16_t src_len,
                                           int32_t *parsed_bytes,
                                           uint16_t *duration) {
...
int32_t generate_disconnect_header(uint8_t *dst, uint16_t dst_len, int32_t *used_bytes) {
  return generate_mqtt_sn_header(dst, dst_len, used_bytes, MQTT_SN_MESSAGE_DISCONNECT_MIN_LENGTH, DISCONNECT);
}
...
int32_t generate_disconnect_internal_duration(uint8_t *dst_pos,
                                              uint16_t dst_len,
                                              uint16_t duration,
                                              int32_t *used_bytes) {
...
int32_t generate_disconnect_duration(uint8_t *dst, uint16_t dst_len, uint16_t duration) {
  ...
  if (generate_disconnect_internal_duration(dst + used_bytes, dst_len, duration, &used_bytes) < 0) {
    return -1;
  }
  return used_bytes;
}
