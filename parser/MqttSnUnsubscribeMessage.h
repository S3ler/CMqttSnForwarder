...
#define MQTT_SN_MESSAGE_UNSUBSCRIBE_W_TOPICID_LENGTH               (MQTT_SN_MESSAGE_UNSUBSCRIBE_HEADER_LENGTH(0) + \
                                                                 MQTT_SN_MESSAGE_UNSUBSCRIBE_FLAGS_LENGTH + \
                                                                 MQTT_SN_MESSAGE_UNSUBSCRIBE_MSG_ID_LENGTH + \
...
#define MQTT_SN_MESSAGE_UNSUBSCRIBE_W_TOPICNAME_MIN_LENGTH         (MQTT_SN_MESSAGE_UNSUBSCRIBE_HEADER_LENGTH(0) + \
                                                                 MQTT_SN_MESSAGE_UNSUBSCRIBE_FLAGS_LENGTH + \
                                                                 MQTT_SN_MESSAGE_UNSUBSCRIBE_MSG_ID_LENGTH + \
...
#define MQTT_SN_MESSAGE_UNSUBSCRIBE_WO_TOPICNAME_MAX_LENGTH        (MQTT_SN_MESSAGE_UNSUBSCRIBE_HEADER_LENGTH(1) + \
                                                                 MQTT_SN_MESSAGE_UNSUBSCRIBE_FLAGS_LENGTH + \
                                                                 MQTT_SN_MESSAGE_UNSUBSCRIBE_MSG_ID_LENGTH)
#define MQTT_SN_MESSAGE_UNSUBSCRIBE_TOPICNAME_MAX_LENGTH           (MQTT_SN_TOPICNAME_MAX_LENGTH - MQTT_SN_MESSAGE_UNSUBSCRIBE_WO_TOPICNAME_MAX_LENGTH)
