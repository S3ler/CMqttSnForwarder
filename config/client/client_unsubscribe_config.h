...
#define CLIENT_MQTT_SN_UNSUBSCRIPTION_TOPIC_ID_TYPE_TOPICID 2
/*
...
typedef struct client_unsubscription_topic_ {
    uint16_t topic_id;
    uint8_t  topic_id_type;
    char *   topic_name;
} client_unsubscription_topic;

typedef struct client_unsubscribe_config_ {
    uint32_t                         unsubscribe_list_max_len;
    client_unsubscription_topic unsubscribe_list[CLIENT_MQTT_SN_MAX_UNSUBSCRIBE];
