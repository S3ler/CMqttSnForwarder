...
#define CLIENT_MQTT_SN_PUBLISH_TOPIC_ID_TYPE_TOPICID 2
#define CLIENT_MQTT_SN_PUBLISH_TOPIC_ID_TYPE_REGISTRATIONINDEX 3

#ifndef CLIENT_MQTT_SN_MAX_PUBLISH
#define CLIENT_MQTT_SN_MAX_PUBLISH 5
#endif

#ifndef CLIENT_MQTT_SN_PUBLISH_DEFAULT_QOS
#define CLIENT_MQTT_SN_PUBLISH_DEFAULT_QOS 0
#endif

#ifndef CLIENT_MQTT_SN_PUBLISH_DEFAULT_TOPIC_ID_TYPE
#define CLIENT_MQTT_SN_PUBLISH_DEFAULT_TOPIC_ID_TYPE CLIENT_MQTT_SN_PUBLISH_TOPIC_ID_TYPE_PREDEFINED
#endif
...
#ifndef CLIENT_MQTT_SN_PUBLISH_DEFAULT_TOPIC_NAME
#define CLIENT_MQTT_SN_PUBLISH_DEFAULT_TOPIC_NAME "default/topic/name"
#endif

#ifndef CLIENT_MQTT_SN_PUBLISH_DEFAULT_TOPIC_ID
#define CLIENT_MQTT_SN_PUBLISH_DEFAULT_TOPIC_ID 1
#endif

#ifndef CLIENT_MQTT_SN_PUBLISH_DEFAULT_RETAIN
#define CLIENT_MQTT_SN_PUBLISH_DEFAULT_RETAIN 0
#endif
...
typedef struct client_publish_config_ {
    int8_t                       qos;
    uint8_t                      topic_id_type;
    uint16_t                     topic_id; //TODO make enum
    uint8_t                      retain;
    char                         default_topic_name[sizeof(CLIENT_MQTT_SN_PUBLISH_DEFAULT_TOPIC_NAME)];
    char *                       topic_name;
